...
class LaptimeDisplayView extends StatefulWidget {
  @override
  // ignore: library_private_types_in_public_api
  _LaptimeDisplayViewState createState() => _LaptimeDisplayViewState();
}

class _LaptimeDisplayViewState extends State<LaptimeDisplayView> {
  UsbPort? _port;
  String _buffer = "";
  String _ms = "";
  String _distance = "";
